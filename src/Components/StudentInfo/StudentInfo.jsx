...
export default function StudentInfo() {
  ...
  useEffect(() => {
    ...
    const fetchStudentData = async () => {
      try {
        const response = await axios.get(`https://registration-production-7fcd.up.railway.app/api/v2/students/${studentID}`);
    ...
    const topFive = async () => {
      try {
        const response = await axios.get(`https://registration-production-7fcd.up.railway.app/api/v2/students/${groupID}/Top5`);
