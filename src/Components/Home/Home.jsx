        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-md-12 mb-4">
              ...
              >
                ...
                <h4 className="text-end text-white">
                  {" "}
                  لا يقعدن أحدكم عن طلب الرزق ويقول: اللهم ارزقني، وقد علم أن
            ...
            <div className="col-md-12">
              <div
                className={`${Style.romady} ${Style.partOne} w-100 rounded-1 d-flex flex-column justify-content-center align-items-center`}
              >
                <h1 className="mb-3">
                  {" "}
                  "Physics: Unveiling Nature's Secrets."
                </h1>
                <p className={`${Style.poppinsRegular} mb-5`}>
                  This is the official website registration for mr.mohsen
                </p>
                <Link
                  className="btn btn-outline-success pe-3 fw-bolder"
                  to={`/group`}
                >
                  {" "}
                  Register now<i className="fa-solid fa-arrow-right ps-2"></i>
                </Link>
              </div>
            </div>
          </div>
