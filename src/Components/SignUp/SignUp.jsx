  ...
  const handleLogin = async () => {
    ...
    try {
      const response = await axios.post(
        "https://registration-production-7fcd.up.railway.app/api/v2/auth/signup",
        payload
      );
      console.log(payload);
      ...
      <div className="row">
        ...
        <div className="col-md-4">
          <div className="py-5">
            ...
            <div
              className={`${Style.memo} d-flex justify-content-center align-items-center`}
            >
            ...
            >
              <button
                className={`${Style.btnOutlineInfo}  py-2 rounded-pill px-5 fw-bolder`}
                onClick={handleLogin}
              >
                Register
              </button>
