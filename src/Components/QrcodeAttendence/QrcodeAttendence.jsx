...
export default function QrcodeAttendence() {
  ...
  function getSingleStudent() {
    axios.get(`https://registration-production-7fcd.up.railway.app/api/v2/students/${ID}`)
      .then(response => {
  ...
  function getlastAttendence() {
    axios.get(`https://registration-production-7fcd.up.railway.app/api/v2/attendance/${ID}`)
      .then(response => {
  ...
  useEffect(() => {
    if (selectedGroup) {
      axios.get(`https://registration-production-7fcd.up.railway.app/api/v2/sessions/${selectedGroup}`)
        .then(response => {
  ...
  const handleAttendance = () => {
    ...
    axios.post(`https://registration-production-7fcd.up.railway.app/api/v2/attendance/${selectedGroup}/${selectedSession}/${ID}`)
      .then(response => {
