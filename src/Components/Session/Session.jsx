...
export default function Session() {
  ...
  useEffect(() => {
    axios.get(`https://registration-production-7fcd.up.railway.app/api/v2/sessions/${ID}`)
      .then(response => {
  ...
  const deleteSession = async (id) => {
    try {
      await axios.delete(`https://registration-production-7fcd.up.railway.app/api/v2/sessions/${ID}/${id}`);
